...
const DeltaSet = new r.Struct({
  shortDeltas: new r.Array(r.int16, (t: any) => t.parent.shortDeltaCount),
  regionDeltas: new r.Array(
    r.int8,
    (t: any) => t.parent.regionIndexCount - t.parent.shortDeltaCount,
  ),
  deltas: (t: any) => t['shortDeltas'].concat(t['regionDeltas']),
});
