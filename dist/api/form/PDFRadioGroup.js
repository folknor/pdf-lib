import { AcroButtonFlags, PDFAcroRadioButton, PDFDict, PDFHexString, PDFName, } from '../../core/index.js';
...
import { defaultRadioGroupAppearanceProvider, normalizeAppearance, } from './appearances.js';
...
export default class PDFRadioGroup extends PDFField {
    ...
    addOptionToPage(option, page, options) {
        ...
        const backgroundColor = options && 'backgroundColor' in options
