...
import { type CopyOptions, type PageBoundingBox, PDFCatalog, PDFContext, PDFDict } from '../core/index.js';
import PDFRef from '../core/objects/PDFRef.js';
import { type SecurityOptions } from '../core/security/PDFSecurity.js';
...
import { type AttachmentOptions, type Base64SaveOptions, type CreateOptions, type EmbedFontOptions, type IncrementalSaveOptions, type LoadOptions, type SaveOptions, type SetTitleOptions } from './PDFDocumentOptions.js';
...
export default class PDFDocument {
     ...
     */
    static load(pdf: string | Uint8Array<ArrayBuffer> | ArrayBuffer, options?: LoadOptions): Promise<PDFDocument>;
    /**
     ...
     */
    copyPages(srcDoc: PDFDocument, indices: number[], options?: CopyOptions): Promise<PDFPage[]>;
    /**
     ...
     */
    attach(attachment: string | Uint8Array<ArrayBuffer> | ArrayBuffer, name: string, options?: AttachmentOptions): Promise<void>;
     ...
     */
    embedFont(font: StandardFonts | string | Uint8Array<ArrayBuffer> | ArrayBuffer, options?: EmbedFontOptions): Promise<PDFFont>;
    /**
     ...
     */
    embedJpg(jpg: string | Uint8Array<ArrayBuffer> | ArrayBuffer): Promise<PDFImage>;
    /**
     ...
     * @returns Resolves with the embedded image.
     */
    embedPng(png: string | Uint8Array<ArrayBuffer> | ArrayBuffer): Promise<PDFImage>;
     ...
     */
    embedPdf(pdf: string | Uint8Array<ArrayBuffer> | ArrayBuffer | PDFDocument, indices?: number[]): Promise<PDFEmbeddedPage[]>;
    /**
