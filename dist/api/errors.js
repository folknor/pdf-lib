...
export class InvalidFontkitError extends Error {
    constructor() {
        const msg = 'Invalid fontkit instance passed to `PDFDocument.registerFontkit`. The fontkit instance must be an object with a `create` method. Ensure you have installed and imported fontkit correctly: `npm install @pdf-lib/fontkit` and `import fontkit from "@pdf-lib/fontkit"`.';
        super(msg);
    }
}
// TODO: Include link to documentation with example
...
export class EncryptedPDFCopyError extends Error {
    constructor() {
        const msg = 'Cannot copy pages from an encrypted PDF that was loaded with `ignoreEncryption: true`. ' +
