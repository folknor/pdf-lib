...
export default class KernProcessor {
    ...
    getKerning(left, right) {
        ...
        for (const table of this.kern.tables) {
            ...
            switch (table.format) {
                case 0: {
                    const pairIdx = binarySearch(s.pairs, (pair) => left - pair.left || right - pair.right);
                    if (pairIdx >= 0) {
                ...
                case 2: {
                    ...
                    if (left >= s.leftTable.firstGlyph &&
                    ...
                    if (right >= s.rightTable.firstGlyph &&
...
//# sourceMappingURL=KernProcessor.js.map