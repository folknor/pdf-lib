...
export function mapOTToAAT(inputFeatures) {
    const res = {};
...
function mapFeatureStrings(f) {
    ...
    const typeCode = Number.isNaN(type)
        ? features[type]?.code
        : type;
    const settingCode = Number.isNaN(setting)
        ? features[type]?.[setting]
        : setting;
...
export function mapAATToOT(inputFeatures) {
    const res = {};
...
//# sourceMappingURL=AATFeatureMap.js.map