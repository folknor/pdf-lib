...
export default class CFFOperand {
    ...
    static size(value) {
        ...
        else if (-107 <= numValue && numValue <= 107) {
            return 1;
        }
        else if ((108 <= numValue && numValue <= 1131) ||
            (-1131 <= numValue && numValue <= -108)) {
            return 2;
        }
        else if (-32768 <= numValue && numValue <= 32767) {
            return 3;
        }
        else {
            return 5;
...
//# sourceMappingURL=CFFOperand.js.map