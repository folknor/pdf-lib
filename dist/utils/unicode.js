 ...
 */
// prettier-ignore
const readBOM = (bytes) => hasUtf16BigEndianBOM(bytes)
    ? ByteOrder.BigEndian
...
export const hasUtf8BOM = (bytes) => bytes[0] === 0xef && bytes[1] === 0xbb && bytes[2] === 0xbf;
/**
 ...
 * @returns The decoded string.
 */
export const utf8Decode = (input, byteOrderMark = true) => {
