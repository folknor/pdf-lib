...
export type TypeDescriptor = 'null' | 'undefined' | 'string' | 'number' | 'boolean' | 'symbol' | 'bigint' | 'function' | DateConstructor | ArrayConstructor | Uint8ArrayConstructor | ArrayBufferConstructor | [
    {
        prototype: unknown;
