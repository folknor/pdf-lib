...
export declare const decodeFromBase64: (base64: string) => Uint8Array<ArrayBuffer>;
/**
 ...
 */
export declare const decodeFromBase64DataUri: (dataUri: string) => Uint8Array<ArrayBuffer>;
